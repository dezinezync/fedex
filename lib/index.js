...
function FedEx(args) {
  ...
  var resources = {
    ...
    track: {f: buildTrackingRequest, r: handleTrackingResponse, wsdl: 'TrackService_v10.wsdl', path: '/web-services', version: {ServiceId: 'trck', Major: 10, Intermediate: 0, Minor: 0}},
