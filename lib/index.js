...
function FedEx(args) {
  ...
  var resources = {
    ...
    track: {f: buildTrackingRequest, r: handleTrackingResponse, wsdl: 'TrackService_v18.wsdl', path: '/web-services', version: {ServiceId: 'trck', Major: 18, Intermediate: 0, Minor: 0}},
